...
Router.map(function () {
	...
	this.route("appointments", {path: "/appointments", controller: "AppointmentsController"});
	this.route("appointments.insert", {path: "/appointments/insert", controller: "AppointmentsInsertController"});
	this.route("appointments.details", {path: "/appointments/details/:Id", controller: "AppointmentsDetailsController"});
	this.route("appointments.edit", {path: "/appointments/edit/:Id", controller: "AppointmentsEditController"});
